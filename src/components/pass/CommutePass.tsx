  ...
  return (
    <div className="w-full max-w-[390px] mx-auto pb-24 px-3 space-y-3 animate-in fade-in pt-1">
      ...
      <div className="floating-surface rounded-3xl p-5 shadow-specular space-y-4 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-zinc-900 dark:bg-[#0E141B] rounded-2xl text-white space-y-2 relative shadow-floating-dark">
          <div className="bg-white p-2.5 rounded-2xl shadow-floating-sm">
        ...
        <div className="floating-surface rounded-2xl p-3.5 space-y-2 shadow-specular text-xs">
          ...
          <div className="space-y-1.5 text-[11px]">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-100/90 dark:bg-emerald-950/60 px-2 py-0.5 rounded-lg text-[10px] shadow-2xs">
