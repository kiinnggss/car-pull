...
export const QuickBidPills: React.FC<QuickBidPillsProps> = ({ onAccept, onPass }) => {
  ...
  return (
    ...
    <div className="w-full bg-white border border-[#DDD4C5] rounded-2xl p-2.5 space-y-2 shadow-xs">
      ...
      <div className="flex items-center justify-between bg-[#F8F5EE] border border-[#DDD4C5] rounded-xl px-2.5 py-1">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="w-7 h-7 rounded-lg bg-white hover:bg-stone-100 disabled:opacity-30 border border-[#DDD4C5] flex items-center justify-center text-[#141210] active:scale-95 transition-all shadow-2xs"
          ...
          <button
            onClick={() => adjustBid(500)}
            className="w-7 h-7 rounded-lg bg-white hover:bg-stone-100 border border-[#DDD4C5] flex items-center justify-center text-[#0D6E6E] active:scale-95 transition-all shadow-2xs"
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={onPass}
          className="w-[32%] min-h-[44px] bg-[#F8F5EE] hover:bg-red-50 border border-[#DDD4C5] hover:border-red-200 text-[#70665A] hover:text-red-700 rounded-xl flex items-center justify-center gap-1 font-bold text-xs transition-all active:scale-95 shadow-2xs"
        >
